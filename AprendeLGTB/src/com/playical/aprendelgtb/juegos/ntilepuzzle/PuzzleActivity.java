 ...
 *******************************************************************************/
package com.playical.aprendelgtb.juegos.ntilepuzzle;
...
import com.playical.aprendelgtb.juegos.ntilepuzzle.PuzzleView.ShowNumbers;
...
public class PuzzleActivity extends Activity
{
	...
	protected static final String FILENAME_DIR = "AprendeLGTB";
	protected static final String FILENAME_PHOTO_DIR = FILENAME_DIR + "/imagenes";
	protected static final String FILENAME_PHOTO = "imagen.jpg";
...
//		if(imageUri == null || b.getBoolean("new", false))
//		{
        final int image = b.getInt("image");
        DEFAULT_SIZE = b.getInt("dificultad", 2);
...
//		}
	...
	protected void newImage(int image)
	{
		LinkedList<Uri> availableImages = new LinkedList<Uri>();
		Uri imageUri_1 = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" +
                getResources().getResourcePackageName(R.drawable.perro_1_solid) + '/' +
                getResources().getResourceTypeName(R.drawable.perro_1_solid) + '/' +
                getResources().getResourceEntryName(R.drawable.perro_1_solid) );
		
		Uri imageUri_2 = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" +
                getResources().getResourcePackageName(R.drawable.gato_1_solid) + '/' +
                getResources().getResourceTypeName(R.drawable.gato_1_solid) + '/' +
                getResources().getResourceEntryName(R.drawable.gato_1_solid) );
		
		Uri imageUri_3 = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" +
                getResources().getResourcePackageName(R.drawable.foto_grupo) + '/' +
                getResources().getResourceTypeName(R.drawable.foto_grupo) + '/' +
                getResources().getResourceEntryName(R.drawable.foto_grupo) );
		
		availableImages.add(imageUri_2);
		availableImages.add(imageUri_1);
		availableImages.add(imageUri_3);
...
//		int index = new Random().nextInt(availableImages.size());
		loadBitmap(availableImages.get(image));
	}
...
//				return true;
	...
	public PuzzleStats updateStats()
	{
        ...
        final SharedPreferences.Editor dataEditor = settings.edit();
		...
		dataEditor.putInt("exp", expUser + i);
		dataEditor.putBoolean("logro_2", true);
		
		AlertDialog.Builder builder_2 = new AlertDialog.Builder(PuzzleActivity.this);
		String text = "¡Has obtenido el logro 'Puzzle' y has ganado " + i + "EXP!";
		
		if(calcularSubidaNivel(expUser + i) == true){
			dataEditor.putInt("nivel", nivel + 1);
			text = "¡Has obtenido el logro 'Puzzle', has ganado " + i + "EXP y has subido de nivel!";
		}
		dataEditor.commit();
		
        builder_2.setMessage(text)
        ...
        final AlertDialog endFragment = builder_2.create();
